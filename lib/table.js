...
exports = module.exports = class {
    ...
    update(id, changes, callback) {
        ...
        const batch = Array.isArray(id);

        Unique.reserve(this, changes, (batch ? true : id), (err, postUnique) => {
            ...
            const query = (batch ? this.raw.getAll(RethinkDB.args(id)) : this.raw.get(id));
