...
exports = module.exports = class {
    ...
    constructor(name, db, options) {
        ...
        if (options.id) {
            this._id = {
                table: this._db._generateTable(options.id.table),
                record: options.id.record || name,
                key: options.id.key || 'value',
                initial: options.id.initial || 1,
                radix: options.id.radix || 10,
                verified: false
            };
        }
