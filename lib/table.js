...
exports = module.exports = class {
    ...
    get(ids, options = {}) {
        ...
        try {
            ...
            throw this._error('get', err.message, diag);
        }
    ...
    exist(id) {
        ...
        try {
            ...
            throw this._error('exist', err.message, diag);
        }
    ...
    async single(criteria) {
        ...
        if (result.length !== 1) {
            throw this._error('single', 'Found multiple items', diag);
        }
    ...
    _error(action, err, inputs, flags) {
        ...
        throw internals.error(this.name, action, err, inputs, flags);
    }
